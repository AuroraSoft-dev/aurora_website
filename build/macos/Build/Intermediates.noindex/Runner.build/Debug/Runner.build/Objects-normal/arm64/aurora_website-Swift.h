...
#ifndef AURORA_WEBSITE_SWIFT_H
#define AURORA_WEBSITE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="aurora_website",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14aurora_website11AppDelegate")
...
SWIFT_CLASS("_TtC14aurora_website17MainFlutterWindow")
